...
import static camt.se234.unittest.entity.User.builder;
...
public class UserDaoImpl {
    ...
    public UserDaoImpl() {
        ...
        users.add(builder().name("Honey").username("Honey").password("aabbcc")
                .dateOfBirth(LocalDate.of(2012,11,13)).telephoneNo("0000000000").build());
        users.add(builder().name("NoName").username("None").password("none")
